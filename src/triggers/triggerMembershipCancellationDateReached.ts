...
const hookLabel = "Membership Cancellation Date Reached";
const event = "membership_cancellation_date_reached";
...
const trigger: HookTrigger = {
  ...
  display: {
    label: hookLabel,
    description: "Triggers on the day when membership cancellation applies.",
  },
  operation: {
    type: "hook",
