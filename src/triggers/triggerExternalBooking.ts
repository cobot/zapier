...
import { getExternalBookings, listRecentBookings, listRecentExternalBookings, subscribeHook, unsubscribeHook } from '../utils/api';
...
async function subscribeHookExecute(z: ZObject, bundle: KontentBundle<SubscribeBundleInputType>) {
...
async function unsubscribeHookExecute(z: ZObject, bundle: KontentBundle<SubscribeBundleInputType>) {
...
export default {
  ...
  operation: {
    ...
    performList: (z: ZObject, bundle: KontentBundle<SubscribeBundleInputType>) =>
